 ...
 */
@Service
public class ProductServiceBaseLockChoice implements ProductService {
    ...
    public Product get(Long productId) {
        ...
        /**
         *  1.如果使用 hotCacheLock.lock()，那么每个线程都要在此加锁排队等待，然后解锁
         *  2.如果知道下面的逻辑能在1s内结束，可以使用hotCacheLock.tryLock(1,TimeUnit.SECONDS);
         *      这样线程就不需要进行加锁排队等待和解锁操作
         *  3.如果1s内没执行完，会导致大量请求打穿到数据库
         */
//        hotCacheLock.lock();
        try {
